...
os.system(f'talon --db {snakemake.input.db} --build {snakemake.params.genome_name} --threads {snakemake.threads} --o {snakemake.params.output_prefix} --f {snakemake.output.config} --tmpDir $TMPDIR > {snakemake.log} 2>&1')
